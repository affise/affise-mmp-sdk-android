...
![last commit](https://badges.ws/github/last-commit/affise/affise-mmp-sdk-android)

[![Change Log](https://badges.ws/badge/Change%20Log?icon=android)](CHANGELOG.md)
...
dependencies {
    // ...
    // Add Affise library 
    implementation(files("libs/attribution-1.7.13.aar"))
    // Add Affise modules 
